        ...
        case HTTP_EVENT_ON_DATA:
            ...
            if (!esp_http_client_is_chunked_response(evt->client)) 
            {
                ...
                else 
                {
                    ...
                    {
                        // Initialize output_buffer with 0 because it is used by strlen() and similar functions therefore should be null terminated.
...
// TBD: make it so that host and path are set to some default site
